	...
	return (
		<div className="rounded-lg bg-white">
			<div className="flex flex-col lg:flex-row w-full md:w-[650px] lg:w-[960px] mx-auto overflow-hidden">
				<div className="flex-shrink-0 flex items-center justify-center w-full lg:w-430px max-h-430px lg:max-h-full overflow-hidden bg-white-300">
					<img
				...
				<div className="flex flex-col p-5 md:p-8 w-full">
					...
					{Object.keys(variations).map((variation) => {
						return (
							//console.log('data222',variations[variation][0]["options"])
							<ProductAttributes
								key={`popup-attribute-key${variation}`}
								title={variation}
								options={variations[variation][0]["options"]}
